...
interface StyleObject {
	...
	props?: { [key: string]: (...value) => StyleRuleObject };
}
...
export interface ComponentOptions {
	...
	style?: StyleObject | StyleRuleObject;
...
export declare abstract class VueDirective {
	arg: string;
	name: string;
	vm: Object;
	el: HTMLElement;
...
export declare function Mixin(options?: MixinOptions): (target: any) => any;
export declare function Watch(name: string): (target: any, key: string) => void;
export declare function On(eventName: string): (target: any, key: string) => void;
export declare function Component(options?: ComponentOptions): (target: any) => any;
export declare function Once(eventName: string): (target: any, key: string) => void;
export declare function Action(action: Function): (target: any, key: string) => void;
export declare function Prop(options?: PropOption): (target: any, key: string) => void;
export declare function Filter(filterName: string, local?: boolean): (target: any) => any;
export declare function Directive(options: DirectiveOptions | string): (target: any) => any;
export declare function Getter(getter: string | Function): (target: any, key: string) => void;
export declare function Watch(name: string, options: WatchOption): (target: any, key: string) => void;
...
export interface StyleRules {
	...
	[property: string]: {} | number | StyleRules | KeyFramesRule;
}
