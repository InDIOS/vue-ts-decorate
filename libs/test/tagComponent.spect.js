...
describe('Tag Component', function () {
    ...
    describe('.options', function () {
        describe('.components', function () {
            ...
            it(' should contain TagComponent property', function () {
                expect(this.options.components.TagComponent).toBeDefined();
                expect(typeof this.options.components.TagComponent).toBe('function');
            });
        });
...
//# sourceMappingURL=tagComponent.spect.js.map